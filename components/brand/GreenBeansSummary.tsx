...
export default function GreenBeansSummary({
  logoSrc,
  docTopics
}: {
  logoSrc: string;
  ...
  const t =
    lang === "en"
      ? {
          ...
          asik: "ASIK",
          values: "Values",
          summaryLead: "Coffee + community, built for consistency and comfort.",
          cardsOverview: [
            { icon: "coffee", title: "Coffee", desc: "Crafted drinks with a clear identity." },
            { icon: "groups", title: "Community", desc: "A shared space for ideas and connection." },
            { icon: "nest_clock_farsight_analog", title: "Relax", desc: "Atmosphere made for staying a while." }
          ],
          quote: "A coffee shop is more than a drink — it’s where ideas begin.",
          cardsQuality: [
            { icon: "eco", title: "Selected beans", desc: "Quality ingredients with maintained standards." },
            { icon: "science", title: "Precise brew", desc: "Technique that keeps taste consistent." },
            { icon: "star", title: "Consistency", desc: "Stable experience, visit after visit." }
          ],
          cardsAudience: [
            { icon: "school", title: "Students", desc: "Focus-friendly place to study." },
            { icon: "work", title: "Professionals", desc: "Meetings or deep work with comfort." },
            { icon: "diversity_3", title: "Friends & family", desc: "Quality time in an inclusive space." }
          ],
          cardsAsik: [
      ...
      : {
          ...
          asik: "ASIK",
          values: "Nilai",
          summaryLead: "Kopi + ruang komunal, fokus pada konsistensi dan kenyamanan.",
          cardsOverview: [
            { icon: "coffee", title: "Kopi", desc: "Minuman diracik dengan identitas yang jelas." },
            { icon: "groups", title: "Komunitas", desc: "Ruang bersama untuk ide dan koneksi." },
            { icon: "nest_clock_farsight_analog", title: "Santai", desc: "Atmosfer nyaman untuk berlama-lama." }
          ],
          quote: "Kedai kopi bukan sekadar minuman—di sinilah ide bermula.",
          cardsQuality: [
            { icon: "eco", title: "Biji pilihan", desc: "Bahan berkualitas dengan standar terjaga." },
            { icon: "science", title: "Seduh presisi", desc: "Teknik yang menjaga rasa konsisten." },
            { icon: "star", title: "Konsisten", desc: "Pengalaman stabil di setiap kunjungan." }
          ],
          cardsAudience: [
            { icon: "school", title: "Pelajar", desc: "Tempat nyaman untuk fokus." },
            { icon: "work", title: "Profesional", desc: "Cocok untuk meeting atau kerja." },
            { icon: "diversity_3", title: "Teman & keluarga", desc: "Ruang inklusif untuk quality time." }
          ],
          cardsAsik: [
